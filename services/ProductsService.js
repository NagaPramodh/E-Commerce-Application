const PRODUCTS = [
  ...
  },
  {
    ...
    price: 600,
    image: require("../assets/products/car-102.jpg"),
    description:
  ...
  },
  {
    ...
    name: "Redmi Mobile",
    price: 10000,
    image: require("../assets/products/mobile.jpg"),
    description:
      "A mobile with a headphone with microphone. Mobiless are made with  is made from a variety of metals, with the most common being aluminum alloys).",
  },
  {
    id: 103,
    name: "FastLane Modal Car",
    price: 600,
  ...
  {
    id: 105,
    name: "Radio Flyer Car",
    price: 500,
    image: require("../assets/products/car-103.jpg"),
    description:
      "A model car, or toy car, is a miniature representation of an automobile. Other miniature motor vehicles, such as trucks, buses, or even ATVs, etc. are often included in this general category.",
  },
